...
(function (global, factory) {
    ...
    function AtRule(
      ...
      if (rules) {
        if (Array.isArray(rules)) {
          ...
          _this.rules = [rules];
          _this.rules[0].selectors = new Selector(
            [],
            null,
            null,
            index,
  ...
  var Definition = /** @class */ (function (_super) {
    ...
    function Definition(
      ...
      _this.selectors = [
        new Selector([
          new Element(null, name, false, _this._index, _this._fileInfo),
        ]),
      ];
      _this.params = params;
      _this.condition = condition;
    ...
    Definition.prototype.matchArgs = function (args, context) {
      ...
      for (var i_1 = 0; i_1 < len; i_1++) {
        if (!this.params[i_1].name && !this.params[i_1].variadic) {
          if (
            args[i_1].value.eval(context).toCSS() !=
            this.params[i_1].value.eval(context).toCSS()
          ) {
            return false;
          }
        }
          ...
          for (m = 0; m < candidates.length; m++) {
            ...
            if (candidate === defNone || candidate === defaultResult) {
              try {
                ...
                var newRules = mixin.evalCall(context, args, this.important)
                  .rules;
  ...
  var AbstractPluginLoader = /** @class */ (function () {
    ...
    AbstractPluginLoader.prototype.evalPlugin = function (
      ...
      var shortname = new this.less.FileManager().extractUrlParts(filename)
        .filename;
      if (filename) {
    ...
    ProcessExtendsVisitor.prototype.isElementValuesEqual = function (
      ...
      if (elementValue1 instanceof tree.Selector) {
        ...
        for (var i_1 = 0; i_1 < elementValue1.elements.length; i_1++) {
          if (
            elementValue1.elements[i_1].combinator.value !==
            elementValue2.elements[i_1].combinator.value
          ) {
            if (
              i_1 !== 0 ||
              (elementValue1.elements[i_1].combinator.value || " ") !==
          ...
          if (
            !this.isElementValuesEqual(
              elementValue1.elements[i_1].value,
              elementValue2.elements[i_1].value
            )
          ) {
            return false;
          }
      ...
      parse: function (str, callback, additionalData) {
        ...
        if (context.pluginManager) {
          ...
          for (var i_2 = 0; i_2 < preProcessors.length; i_2++) {
            str = preProcessors[i_2].process(str, {
              context: context,
              imports: imports,
              fileInfo: fileInfo,
            });
    ...
    "%": function (string /* arg, arg, ... */) {
      ...
      var _loop_1 = function (i_1) {
        ...
        result = result.replace(/%[sda]/i, function (token) {
          var value =
            args[i_1].type === "Quoted" && token.match(/s/i)
              ? args[i_1].value
              : args[i_1].toCSS();
    ...
    var ParseTree = /** @class */ (function () {
      ...
      ParseTree.prototype.toCSS = function (options) {
        ...
        for (var file_1 in this.imports.files) {
          if (
            this.imports.files.hasOwnProperty(file_1) &&
            file_1 !== this.imports.rootFilename
          ) {
  ...
  var root = function (window, options) {
    ...
    less.registerStylesheetsImmediately = function () {
      ...
      for (var i_3 = 0; i_3 < links.length; i_3++) {
        if (
          links[i_3].rel === "stylesheet/less" ||
          (links[i_3].rel.match(/stylesheet/) &&
